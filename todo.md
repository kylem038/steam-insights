...
[X] Images should use Image component from NextJS
[X] Re-check whether we need force-dynamic - use time based revalidation
...
Given a set of tags - what would be an estimated number of steam page views
